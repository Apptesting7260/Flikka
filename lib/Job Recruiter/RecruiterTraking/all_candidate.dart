          ...
          case Status.COMPLETED:
            return Obx(() {
              switch (jobsController.rxRequestStatus.value) {
                ...
                case Status.COMPLETED:
                  return Obx(() {
                    switch (jobTitleController.rxRequestStatus.value) {
                      case Status.LOADING:
                        return const Scaffold(
                          body: Center(child: CircularProgressIndicator()),);
                      case Status.ERROR:
                        if (jobTitleController.error.value == 'No internet') {
                          return Scaffold(
                            body: InterNetExceptionWidget(
                              onPress: () {
                                jobTitleController.recruiterJobTitleApi();
                                    ...
                                    ListView.builder(
                                        ...
                                        itemBuilder: (context, i) {
                                          ...
                                          return ListView.builder(
                                              shrinkWrap: true,
                                              physics: const NeverScrollableScrollPhysics(),
                                              itemCount: candidateStatusData
                                                  ?.appliedJob?.length,
                                              itemBuilder: (context, index) {
                                                var data = candidateStatusData
                                                    ?.appliedJob?[index];
                                                return Container(
