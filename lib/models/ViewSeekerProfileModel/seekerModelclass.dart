class ProfileModelSeeker {
 ...
 var message;
  ...
  ProfileModelSeeker.fromJson(Map<String, dynamic> json){
    ...
    seekerDtls = SeekerDtls.fromJson(json['seeker_dtls']);
    workExpJob = List.from(json['work_exp_job']).map((e)=>WorkExpJob.fromJson(e)).toList();
    educationLevel = List.from(json['education_level']).map((e)=>EducationLevel.fromJson(e)).toList();
...
var appreciation;
 ...
 var positions;
  ...
  SeekerDtls.fromJson(Map<String, dynamic> json){
    ...
    skillName = List.castFrom<dynamic, dynamic>(json['skill_name']);
    passionName = List.castFrom<dynamic, dynamic>(json['passion_name']);
    industryPreferenceName = List.castFrom<dynamic, dynamic>(json['industry_preference_name']);
    strengthsName = List.castFrom<dynamic, dynamic>(json['strengths_name']);
    startWorkName = List.castFrom<dynamic, dynamic>(json['start_work_name']);
    availabityName = List.castFrom<dynamic, dynamic>(json['availabity_name']);
  }
