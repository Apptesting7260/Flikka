              ...
              child: Column(
                ...
                children: [
                  ...
                  children: [
                    ...
                    Text("Report",style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w700),)
                  ],
                ),
                  SizedBox(height: Get.height*.02,),
                  Text("Report",style: Theme.of(context).textTheme.displayLarge?.copyWith(fontWeight: FontWeight.w700),),
                              ...
                              hint:  Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'Weekly',
                                      style: Get.theme.textTheme.labelLarge?.copyWith(fontWeight: FontWeight.w700),
                  ...
                  GridView.builder(
                    ...
                    itemCount: 7,
                    shrinkWrap: true,
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 40,mainAxisExtent: 70),
                      itemBuilder: (context, index) {
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                         children: [
                           Text("10",style: Theme.of(context).textTheme.displayLarge?.copyWith(fontSize: 30,color: Colors.white,fontWeight: FontWeight.w700),),
                           Text("Match Profile",style: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w500,color: Color(0xffFFFFFF)),)
                         ],
                         ),
                        );
                      },),
                  ...
                  Center(
                    child: Container(
                      width: 200,
                      height: 220, // Increased height to accommodate the label
                      child: Stack(
                        children: [
                          CustomPaint(
                            size: Size(200, 200),
                          ...
                          Positioned(
                            bottom: 50,
                            left: 100,
                            child: PercentageBox(32), // Modified to match the segment value
                          ),
                        ],
                      ),
                    ),
                  ...
                  Center(
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        ...
                        Text("Hired",style: Theme.of(context).textTheme.headlineSmall,),
                        Container(
                          height: 18,
                          width: 18,
                          decoration: BoxDecoration(
                        ...
                        Text("Rejected",style: Theme.of(context).textTheme.headlineSmall,),
                      ],
                    ),
                  ),
