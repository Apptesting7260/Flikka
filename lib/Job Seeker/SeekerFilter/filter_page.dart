    ...
    return Obx(() {
      switch (companiesListController.rxRequestStatus.value ) {
        ...
        case Status.COMPLETED:
          return Obx(() {
            switch (getSkillsController.rxRequestStatus.value) {
              case Status.LOADING:
                return const Scaffold(
                  body: Center(
                      child: CircularProgressIndicator()),
              ...
              case Status.ERROR:
                if (getSkillsController.error.value == 'No internet') {
                  return Scaffold(body: InterNetExceptionWidget(
                    onPress: () {
                      getSkillsController.seekerGetAllSkillsApi();
                    },
                                        ...
                                        onTap1: () {
                                          if(!jobFilterController.loading.value) {
                                            jobFilterController.filterJob( widget.fromMap,context, jobTitleController.text,
                                              ...
                                              RangePicker.minValue, RangePicker.maxValue, employmentType,
