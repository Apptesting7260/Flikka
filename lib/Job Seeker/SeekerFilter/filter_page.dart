          ...
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                ...
                style: Theme.of(context).textTheme.bodyLarge?.copyWith(color: const Color(0xffCFCFCF), fontSize: 19),
                decoration: InputDecoration(
                  hintText: 'Location',
                  hintStyle: Theme.of(context).textTheme.bodyLarge?.copyWith(color: const Color(0xffCFCFCF)),
            ...
            Obx( () => companiesListController.showCompanies.value ?
               Column(
                 children: [
                   ListView.builder(
            ...
            SizedBox(height: Get.height *.1,
                child: RangePicker(maxSalary: double.tryParse("${getSkillsController.seekerGetAllSkillsData.value.salaryExpectation?[0].salaryExpectation ?? 50000}" ),)) ,
            ...
            SizedBox(
              ...
              child: ListView(
                ...
                children: [
                  dropDown(hint: "Date Posted", items: itemsDate,value: dateValue) ,
                  dropDown(hint: "Type of Workplace", items: typeOfWorkplaceItems , value: workplaceType) ,
                  dropDown(hint: "Employment Type", items: employmentTypeItems , value: employmentType),
                  dropDown(hint: "Qualification", items: itemQualification , value: qualificationType) ,
                  DropdownButtonHideUnderline(
                    child: DropdownButton2 (
                      ...
                      items: getSkillsController.seekerGetAllSkillsData.value.softSkill?.map((item) => DropdownMenuItem(
                        value: item.skills,
